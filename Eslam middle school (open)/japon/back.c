...
//        lcd_putchar((-cmp/100)%10+'0');
       ...
       
    {
       ...
       else if(adc_min==6)                          motor(-255+cmp,-128+cmp,255+cmp,128+cmp);///9
       ...
       #asm ("wdr");
        ...
        {  
        if(B<200)                             motor(-255+cmp-e,-255+cmp+e,255+cmp+e,255+cmp-e);// 8
        else if(B>300)                        motor(255+cmp-e,255+cmp+e,-255+cmp+e,-255+cmp-e);//0
