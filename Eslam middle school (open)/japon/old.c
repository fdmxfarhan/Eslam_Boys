...
while (1)
     ...
     cmp=compass_read(1)-c; 
      ...
      read_sensor();  
      if((kr>600)&&(adc[adc_min]>700))
      f=1;
      else if((kb>600)&&(adc[adc_min]>700))
      f=1 ;
      else if((kf>600)&&(adc[adc_min]>700))
      f=1 ;
      else if((kl>600)&&(adc[adc_min]>700))
      f=1  ;
...
//      
//       if ((200< R <250)&&(70< L <100))
//       {
//       ((adc_min==0)||(adc_min==15)||(adc_min==1));
//         motor(-128+cmp,255+cmp,128+cmp,-255+cmp);//13
      ...
      if((adc[adc_min]<700))                                                                                                                       
       ...
       {   
       #asm ("wdr");
       if(B>230 ) motor(255+cmp,255+cmp,-255+cmp,-255+cmp);  
       else      motor(-255+cmp,-255+cmp,255+cmp,255+cmp);///8
       #asm ("wdr");     
       }  
        else if(adc_min==0)             motor(255+cmp,255+cmp,-255+cmp,-255+cmp);////10 
//       else if (((adc_min==1)|| (adc_min==2)|| (adc_min==3 )|| (adc_min==4 )|| (adc_min==5 )|| (adc_min==6 )|| (adc_min==7 ))&&((R>250)&&(R<300)))
//       motor(0+cmp/2,0+cmp/2,0+cmp/2,0+cmp/2);  
//       else if (((adc_min==1)|| (adc_min==2)|| (adc_min==3 )|| (adc_min==4 )|| (adc_min==5 )|| (adc_min==6 )|| (adc_min==7 ))&&( R>300))
//         motor(-128+cmp,128+cmp,128+cmp,-128+cmp);///12 
      
       
       else if(adc_min==1)                          motor(255+cmp,128+cmp,-255+cmp,-128+cmp);///1   motor(255,128,-255,-128);
...
//        {  if(R>230 )         motor(-255+cmp,0+cmp,255+cmp,0+cmp);///10    
//        else                 motor(0+cmp,-255+cmp,0+cmp,255+cmp);///6
//        }
//          else if (((adc_min==9)|| (adc_min==10)|| (adc_min==11 ) || (adc_min==12 )|| (adc_min==13 )|| (adc_min==14 )|| (adc_min==15 ))&&((L>250)&&(L<300))) 
//           motor(0+cmp/2,0+cmp/2,0+cmp/2,0+cmp/2); 
//          else if (((adc_min==9)|| (adc_min==10)|| (adc_min==11 ) || (adc_min==12 )|| (adc_min==13 )|| (adc_min==14 )|| (adc_min==15 ))&&(L>250))
//           
//       
        
//            motor(128+cmp,-128+cmp,-128+cmp,128+cmp);///4  
...
//        else if(L>320)          motor(255+cmp,-255+cmp,-255+cmp,255+cmp);///4
//        else if(R>300)           motor(-255+cmp,255+cmp,255+cmp,-255+cmp);///12
        else if(B>300)          motor(255-e+cmp,255+e+cmp,-255+e+cmp,-255-e+cmp);//0
