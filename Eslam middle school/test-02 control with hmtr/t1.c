...
while (1)
      ...
      b=getchar();
      read_cmp();
      if(b=='w')        motor(v + cmp,v + cmp,-v + cmp,-v + cmp);
      else if(b=='s')        motor(-v + cmp,-v + cmp,v + cmp,v + cmp);
      else if(b=='a')        motor(-v + cmp,v + cmp,v + cmp,-v + cmp);
      else if(b=='d')        motor(v + cmp,-v + cmp,-v + cmp,v + cmp);
      ...
      if(cnt0 < 30 && signature==1)
        {          
        cnt2=0;
        while(sharpright>300 && cnt2<100)
            {               
            cnt2++;
            if(cnt1>20){read_cmp();cnt1=0;}
            cnt1++;
