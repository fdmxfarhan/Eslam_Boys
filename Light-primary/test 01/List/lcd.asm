...
; 0000 004A // Clock value: Timer 1 Stopped
; 0000 004B // Mode: Normal top=FFFFh
...
; 0000 0050 // Timer 1 Overflow Interrupt: Off
...
; 0000 0061 // Clock value: Timer 2 Stopped
; 0000 0062 // Mode: Normal top=FFh
...
; 0000 0077 SFIOR=0x00;
	...
	OUT  0x30,R30
; 0000 0078 
; 0000 0079 // LCD module initialization
...
; 0000 0082        lcd_gotoxy(0,0);
	LDI  R30,LOW(0)
	CALL SUBOPT_0x0
; 0000 0083        lcd_putchar('A');
; 0000 0084 
; 0000 0085        lcd_gotoxy(0,1);
	LDI  R30,LOW(0)
	CALL SUBOPT_0x1
; 0000 0086        lcd_putsf("YAS");
; 0000 0087        delay_ms(2000);
; 0000 0088        lcd_clear();
; 0000 0089 
; 0000 008A 
; 0000 008B        lcd_gotoxy(1,0);
	LDI  R30,LOW(1)
	CALL SUBOPT_0x0
; 0000 008C        lcd_putchar('A');
; 0000 008D 
; 0000 008E        lcd_gotoxy(1,1);
	LDI  R30,LOW(1)
	CALL SUBOPT_0x1
; 0000 008F        lcd_putsf("YAS");
; 0000 0090        delay_ms(2000);
; 0000 0091        lcd_clear();
; 0000 0092 
; 0000 0093 
; 0000 0094        lcd_gotoxy(2,0);
	LDI  R30,LOW(2)
	CALL SUBOPT_0x0
; 0000 0095        lcd_putchar('A');
; 0000 0096 
; 0000 0097        lcd_gotoxy(2,1);
	LDI  R30,LOW(2)
	CALL SUBOPT_0x1
; 0000 0098        lcd_putsf("YAS");
; 0000 0099        delay_ms(2000);
; 0000 009A        lcd_clear();
; 0000 009B 
; 0000 009C 
; 0000 009D 
; 0000 009E        lcd_gotoxy(3,0);
	LDI  R30,LOW(3)
	CALL SUBOPT_0x0
; 0000 009F        lcd_putchar('A');
; 0000 00A0 
; 0000 00A1        lcd_gotoxy(3,1);
	LDI  R30,LOW(3)
	CALL SUBOPT_0x1
; 0000 00A2        lcd_putsf("YAS");
...
; 0000 00A7 
; 0000 00A8 
; 0000 00A9        lcd_gotoxy(4,0);
	LDI  R30,LOW(4)
	CALL SUBOPT_0x0
; 0000 00AA        lcd_putchar('A');
; 0000 00AB 
; 0000 00AC        lcd_gotoxy(4,1);
	LDI  R30,LOW(4)
	CALL SUBOPT_0x1
; 0000 00AD        lcd_putsf("YAS");
...
; 0000 00B2        lcd_gotoxy(5,0);
	LDI  R30,LOW(5)
	CALL SUBOPT_0x0
; 0000 00B3        lcd_putchar('A');
; 0000 00B4 
; 0000 00B5        lcd_gotoxy(5,1);
	LDI  R30,LOW(5)
	CALL SUBOPT_0x1
; 0000 00B6        lcd_putsf("YAS");
; 0000 00B7        delay_ms(2000);
; 0000 00B8        lcd_clear();
; 0000 00B9 
; 0000 00BA 
; 0000 00BB        lcd_gotoxy(6,0);
	LDI  R30,LOW(6)
	CALL SUBOPT_0x0
; 0000 00BC        lcd_putchar('A');
; 0000 00BD 
; 0000 00BE        lcd_gotoxy(6,1);
	LDI  R30,LOW(6)
	CALL SUBOPT_0x1
; 0000 00BF        lcd_putsf("YAS");
...
;OPTIMIZER ADDED SUBROUTINE, CALLED 7 TIMES, CODE SIZE REDUCTION:99 WORDS
SUBOPT_0x1:
	ST   -Y,R30
	LDI  R30,LOW(1)
	ST   -Y,R30
