...
void catch()
    ...
    else if (imin==8)     motor(-v,-v/2,v,v/2);                                      //motor(-v,-v,v,v);             |
    else if (imin==9)     motor(-v,v/2,v,-v/2);                                      //motor(-v,-v/2,v,v/2);         |
    else if (imin==10)    motor(-v,v,v,-v);                                          //motor(-v,-v/2,v,v/2);         |
    else if (imin==11)    motor(-v/2,v,v/2,-v);                                      //motor(-v,v/2,v,-v/2);         |
    else if (imin==12)    motor(0,v,0,-v);                                           //motor(-v,v,v,-v);             |
    else if (imin==13)    motor(v/2,v,-v/2,-v);                                      //motor(-v/2,v,v/2,-v);         |
    else if (imin==14)     motor(0,v,0,-v);                                          //motor(0,v,0,-v);              |
