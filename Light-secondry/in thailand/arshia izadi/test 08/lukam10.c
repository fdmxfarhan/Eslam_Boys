...
while (1)
      ...
      if(min<=800)
        ...
        if(SR+SL>700) 
          {
          f=1;
          for(i=0;i<200;i++) {motor(-v,-v,v,v);#asm("wdr");}
          } 
        while(f==1 && (imin<=4 || imin>=12) && min<800) 
          {
          #asm("wdr");
          sensor();
          if(SR+SL>700) motor(-v,-v,v,v);
          else motor(0,0,0,0);
          }
        while(SB>250 && imin>=4 && imin<=12 && min<800 && (SL>200 || SR>200) && f==0)
          {           
          #asm("wdr");
          sensor();
          if(SB>400)motor (v,v,-v,-v);
          else motor(0,0,0,0);   
          }
        while(SR>250 && imin>=0 && imin <=8 && min<800 && f==0)
          {           
          #asm("wdr");
          sensor();
        ...
        while(SL>250 && (imin>=8 || imin==0) && min<800 && f==0)
          {           
          #asm("wdr");
          sensor();
