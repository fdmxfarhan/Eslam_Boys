...
_0x3:
	.DB  0x1F,0x3F,0x5F,0x7F
_0xD:
	.DB  0x0,0x0,0xFF,0x0
_0x0:
	.DB  0x25,0x64,0x20,0x20,0x25,0x32,0x78,0x20
	.DB  0x20,0x25,0x32,0x78,0x20,0x20,0x20,0x20
	.DB  0x25,0x32,0x78,0xA,0xD,0x0
_0x2020000:
...
; 0000 0033         mask |= (0x01 && (compare[i] > counter));
	...
	MOV  R30,R9
	LDI  R31,0
	SUBI R30,LOW(-_compare)
	SBCI R31,HIGH(-_compare)
	LD   R30,Z
	CP   R5,R30
	BRSH _0x7
	LDI  R30,1
