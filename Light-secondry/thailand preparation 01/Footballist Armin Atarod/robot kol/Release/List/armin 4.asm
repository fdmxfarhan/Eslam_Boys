...
_0x0:
	.DB  0x40,0x34,0x4D,0x31,0x4E,0x0,0x40,0x54
	.DB  0x40,0x34,0x30,0x44,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 003E // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=Out Bit3=Out Bit2=Out Bit1=In Bit0=In
; 0000 003F DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (1<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(252)
	OUT  0x17,R30
; 0000 0040 // State: Bit7=0 Bit6=0 Bit5=0 Bit4=0 Bit3=0 Bit2=0 Bit1=T Bit0=T
...
; 0000 004B DDRD=(1<<DDD7) | (1<<DDD6) | (1<<DDD5) | (1<<DDD4) | (1<<DDD3) | (1<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(255)
	OUT  0x11,R30
...
; 0000 0051 // Clock value: 15.625 kHz
; 0000 0052 // Mode: Fast PWM top=0xFF
; 0000 0053 // OC0 output: Non-Inverted PWM
; 0000 0054 // Timer Period: 16.384 ms
; 0000 0055 // Output Pulse(s):
; 0000 0056 // OC0 Period: 16.384 ms Width: 0 us
; 0000 0057 TCCR0=(1<<WGM00) | (1<<COM01) | (0<<COM00) | (1<<WGM01) | (0<<CS02) | (1<<CS01) | (1<<CS00);
	LDI  R30,LOW(107)
	OUT  0x33,R30
...
; 0000 005D // Clock value: 15.625 kHz
; 0000 005E // Mode: Fast PWM top=0x00FF
; 0000 005F // OC1A output: Non-Inverted PWM
; 0000 0060 // OC1B output: Non-Inverted PWM
; 0000 0061 // Noise Canceler: Off
; 0000 0062 // Input Capture on Falling Edge
; 0000 0063 // Timer Period: 16.384 ms
; 0000 0064 // Output Pulse(s):
; 0000 0065 // OC1A Period: 16.384 ms Width: 0 us// OC1B Period: 16.384 ms Width: 0 us
...
; 0000 006A TCCR1A=(1<<COM1A1) | (0<<COM1A0) | (1<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (1<<WGM10);
	LDI  R30,LOW(161)
	OUT  0x2F,R30
; 0000 006B TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (1<<WGM12) | (0<<CS12) | (1<<CS11) | (1<<CS10);
	LDI  R30,LOW(11)
	OUT  0x2E,R30
...
; 0000 0079 // OC2 output: Non-Inverted PWM
; 0000 007A // Timer Period: 16.384 ms
; 0000 007B // Output Pulse(s):
; 0000 007C // OC2 Period: 16.384 ms Width: 0 us
; 0000 007D ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 007E TCCR2=(1<<PWM2) | (1<<COM21) | (0<<COM20) | (1<<CTC2) | (1<<CS22) | (0<<CS21) | (0<<CS20);
	LDI  R30,LOW(108)
	OUT  0x25,R30
...
; 0000 0099 // ADC Clock frequency: 62.500 kHz
; 0000 009A // ADC Voltage Reference: AVCC pin
; 0000 009B // ADC Auto Trigger Source: ADC Stopped
; 0000 009C ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(64)
	OUT  0x7,R30
; 0000 009D ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (1<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	LDI  R30,LOW(132)
	OUT  0x6,R30
; 0000 009E SFIOR=(0<<ADTS2) | (0<<ADTS1) | (0<<ADTS0);
	LDI  R30,LOW(0)
	OUT  0x30,R30
; 0000 009F 
...
; 0000 00A9 // Connections are specified in the
; 0000 00AA // Project|Configure|C Compiler|Libraries|Alphanumeric LCD menu:
; 0000 00AB // RS - PORTC Bit 0
; 0000 00AC // RD - PORTC Bit 1
; 0000 00AD // EN - PORTC Bit 2
; 0000 00AE // D4 - PORTC Bit 4
; 0000 00AF // D5 - PORTC Bit 5
; 0000 00B0 // D6 - PORTC Bit 6
; 0000 00B1 // D7 - PORTC Bit 7
