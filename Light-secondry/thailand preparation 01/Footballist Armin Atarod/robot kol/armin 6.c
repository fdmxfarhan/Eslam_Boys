...
void sensor()
{
    ...
    lcd_putsf(" : ");
    lcd_putchar((led[adc_min]/1000)%10 + '0');
    lcd_putchar((led[adc_min]/100)%10 + '0');
    lcd_putchar((led[adc_min]/10)%10 + '0');
    lcd_putchar((led[adc_min]/1)%10 + '0');
}
...
void findball()
{
      ...
      else if(adc_min == 1) motor(128,255,-128,-255);
      else if(adc_min == 2) motor(0,255,0,-255);
      else if(adc_min == 3) motor(-128,255,128,-255);
      else if(adc_min == 4) motor(-255,255,255,-255);
      else if(adc_min == 5) motor(-255,128,255,-128);
      else if(adc_min == 6) motor(-255,0,255,0);
      else if(adc_min == 7) motor(-255,-128,255,128);
      else if(adc_min == 8) motor(-255,-255,255,255);
      else if(adc_min == 9) motor(-128,-255,128,255);
      else if(adc_min == 10) motor(0,-255,0,255);
      else if(adc_min == 11) motor(128,-255,-128,255);
      else if(adc_min == 12) motor(255,-255,-255,255);
      else if(adc_min == 13) motor(255,-128,-255,128);
      else if(adc_min == 14) motor(255,0,-255,0);
      else if(adc_min == 15) motor(255,128,-255,-128);
      }
}
