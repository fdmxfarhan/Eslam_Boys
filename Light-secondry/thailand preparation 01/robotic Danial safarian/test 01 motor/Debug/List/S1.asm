...
; 0000 0081 // OC1A Period: 16.384 ms Width: 0 us// OC1B Period: 16.384 ms Width: 0 us
...
_0x1B:
; 0000 00CF       {
; 0000 00D0       motor(255,255,255,255);
	RCALL SUBOPT_0x0
	RCALL SUBOPT_0x0
	RCALL SUBOPT_0x0
	LDI  R26,LOW(255)
