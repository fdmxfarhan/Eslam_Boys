...
void sensor()
    ...
    sh=read_adc(7);
    lcd_gotoxy(0,1);
    lcd_putchar((sh/100)%10+'0');
    lcd_putchar((sh/10)%10+'0');
    lcd_putchar((sh/1)%10+'0');
    }
...
while (1)
      ...
      if(min<=800)
          ...
          else if(imin==5) motor(-v/2,-v,v/2,v);                        //motor(v/2,-v,-v/2,v);
          else if(imin==6) motor(-v,-v,v,v);                            //motor(0,-v,0,v);
          else if(imin==7) motor(-v,-v/2,v,v/2);                        //motor(-v/2,-v,v/2,v);
          else if(imin==8) motor(0,-v,0,v);                             //motor(-v,-v,v,v);
          else if(imin==9) motor(-v/2,-v,v/2,v);                        //motor(-v,-v/2,v,v/2);
          else if(imin==10)motor(-v,-v,v,v);                            //motor(-v,0,v,0);
