...
void sensor()
    ...
    lcd_putchar(':');    lcd_putchar((min/1000)%10+'0');
...
while (1)
      ...
      sensor();
          ...
          else if (imin==1)  motor(255,128,-255,-128);   
          else if (imin==2)  motor(255,0,-255,0);  
          else if (imin==3)  motor(255,-128,-255,128);  
          else if (imin==4)  motor(255,-255,-255,255);  
          else if (imin==5)  motor(128,-255,-128,255);  
          else if (imin==6)  motor(0,-255,0,255);  
          else if (imin==7)  motor(-128,-255,128,255);  
          
          else if (imin==8)  motor(-255,-255,255,255);
          
          else if (imin==9)  motor(-255,-128,255,128);   
          else if (imin==10) motor(-255,0,255,0);  
          else if (imin==11) motor(-255,128,255,128);  
          else if (imin==12) motor(-255,255,255,-255);  
          else if (imin==13) motor(-128,255,128,-255);  
          else if (imin==14) motor(0,255,0,-255);  
          else if (imin==15) motor(128,255,-128,-255);  
