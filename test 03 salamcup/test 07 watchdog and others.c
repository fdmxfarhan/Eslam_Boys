...
void move(int d)
    ...
    else if (d==1)  motor(vs,vs/2,-vs,-vs/2);
    else if (d==2)  motor(vs,0,-vs,0);
    else if (d==3)  motor(vs,-vs/2,-vs,vs/2);
    else if (d==4)  motor(vs,-vs,-vs,vs);
    ...
    else if (d==12) motor(-vs,vs,vs,-vs);
    else if (d==13) motor(-vs/2,vs,vs/2,-vs);
    else if (d==14) motor(0,vs,0,-vs);
    else if (d==15) motor(vs/2,vs,-vs/2,-vs);
    }
...
void catch()
    ...
    if(a!=0)
        ...
        if(y<=60) 
            {
            if(x>30 && x<=70)           {move(2);imin=2;} //3
            else if(x>70 && x<=110)     {move(2);imin=2;}
            else if(x>110 && x<=150)    {move(0);imin=0;}
            else if(x>150 && x<=190)    {move(14);imin=14;}  
            else if(x>190 && x<=230)    {move(14);imin=14;}  //13
            }
        else if(y>60 && y<=120)   
            {
            if(x>30 && x<=70)           {move(6);imin=4;}
            else if(x>70 && x<=90)     {move(7);imin=4;}
            else if(x>90 && x<=170)    {move(0);imin=0;}
            else if(x>170 && x<=190)    {move(9);imin=12;}
            else if(x>190 && x<=230)    {move(10);imin=12;}
            }
        else if(y>120 && y<=180)  
            {
            if(x>30 && x<=70)           {move(8);imin=6;}
            else if(x>70 && x<=110)     {move(8);imin=6;}
            else if(x>110 && x<=150)    {move(4);imin=8;}
            else if(x>150 && x<=190)    {move(8);imin=10;}
            else if(x>190 && x<=230)    {move(8);imin=10;}
            }                        
        else if(y>180)         
            {
            if(x>30 && x<=70)           {move(8);imin=6;}
...
void out_kaf()
    {
    while(out=='R' && a!=0 && x<170)
        {
        sensor();
        read_pixy();
        if(SKR>400 || SKL>600 || SKF>600 || SKB>600)   motor(-v,v,v,-v);
        else  motor(0,0,0,0);
        PORTD.6=1;
        }
    while(out=='L' && a!=0 && x>140)
        {
        sensor();
        read_pixy();
        if(SKR>500 || SKL>600 || SKF>600 || SKB>600)   motor(v,-v,-v,v);
        else  motor(0,0,0,0);
        PORTD.6=1;
        } 
    while(out=='B' && a!=0 && y>100)
        {
        sensor();
        read_pixy();
        if(SKR>500 || SKL>600 || SKF>600 || SKB>600)   motor(v,v,-v,-v);
...
void out_sharp()
    ...
    while(SR>300 && a!=0 && x<170)
        {
        sensor();
        read_pixy();
        if(SR>450)   motor(-v,v,v,-v);
        else  motor(0,0,0,0);
        PORTD.6=1;
        }
    while(SL>300 && a!=0 && x>140)
        {
        sensor();
        read_pixy();
        if(SL>450)   motor(v,-v,-v,v);
        else  motor(0,0,0,0);
        PORTD.6=1;
        } 
    while(SB>300 && a!=0 && y>100)
        {
        sensor();
        read_pixy();
        if(SB>450)   motor(v,v,-v,-v);
        else  motor(0,0,0,0);
        PORTD.6=1;
        } 
    while(f==1 && a!=0 && y<100)
        ...
        sensor();
        read_pixy();
        if(SKF>600 || SKB>600)   motor(-v,-v,v,v);
        else  motor(0,0,0,0);
        PORTD.6=1;
        }     
    f=0;
...
while (1)
      ...
      read_pixy();
      //x-=30; 
      if (SKR>400 || SKL>600 || SKF>600 || SKB>600)
        {
        if(SKR>400)
            {
            if(SL>400) {motor(v,-v,-v,v);out='L';}
            else       {motor(-v,v,v,-v);out='R';}
            delay_ms(200);
            }
        else if(SKL>600)
            {
            if(SR>400) {motor(-v,v,v,-v);out='R';}
            ...
            {
            if(SKB>600);
            else if(SB>400) {motor(v,v,-v,-v);out='B';}
            else {motor(-v,-v,v,v);out='F';}
            delay_ms(200);
            }
        else if(SKB>600)
            {
            if(SKF>600);
            else if(SB>250) {motor(v,v,-v,-v);out='B';}
            else {motor(-v,-v,v,v);out='F';}
            delay_ms(200);
            }
        PORTD.6=1;
